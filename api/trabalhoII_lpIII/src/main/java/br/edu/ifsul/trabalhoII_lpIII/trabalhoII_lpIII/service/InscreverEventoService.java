...
public class InscreverEventoService {
    ...
    public void inscrever(Long idDeputado, Long idEvento) {
        ...
        if(eventoRepository.existsByIdAndDeputados(idEvento, deputado)){
            throw new ResponseStatusException(BAD_REQUEST, "Deputado já inscrito nesse evento.");
        }
        ...
        eventosDeputado.add(evento);

        deputadosEvento.add(deputado);
